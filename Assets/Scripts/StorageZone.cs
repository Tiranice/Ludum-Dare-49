...
namespace LudumDare49
{
    public class StorageZone : Interactable
    {
        ...
        [Space]
        [SerializeField] private int _maxStorage = 1;
        ...
        private ConcurrentBag<GameObject> _storedObjects = new ConcurrentBag<GameObject>();
        ...
        public override string InteractionType => !_storedObjects.IsEmpty
            ? $"{_boundReagentType.Name} ({_storedObjects.Count} / {_maxStorage})"
